...
export default function AdminCMS({ 
  ...
  const [settingsForm, setSettingsForm] = useState(siteSettings || {
    ...
    heroSubtitle: 'طب یونانی، قانون مفرد اعضاء، ہربل علاج، اور 400+ مستند سائنسی و طبی مضامین کا سب سے بڑا ڈیجیٹل خزانہ',
                            ...
                            <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto justify-end font-simple text-xs">
                              {isPending ? (
                                <>
                                  ...
                                  >
                                    <CheckCircle2 className="w-4 h-4" />
                                    <span>B(HD �1̺ 'H1 ~(D4 �1̺ (Approve)</span>
                                  </button>
                                  ...
                                  <button
                                    type="button"
                                    onClick={() => alert('*A5�D'* *(/�D �1F� �� D�� 7(�( �� ��4 (H1� E̺ ,'&̺�')}
                                ...
                                <>
                                  <button
                                    ...
                                    title="7(�( �� ~1HA'&D �� *5/�B �1̺"
                                  >
                                    {doc.isVerified ? '*5/�B 4/�' : '*5/�B �1̺'}
                                  </button>
